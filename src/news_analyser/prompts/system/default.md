...

{
  ...
  "framing_target": {
    ...
    "bias_score": <float between -1.0 (strongly left/progressive) and +1.0 (strongly right/conservative), 0.0 = neutral>
  }
}
